# Comparing `tmp/terrainman-0.0.14.tar.gz` & `tmp/terrainman-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "terrainman-0.0.14.tar", max compression
+gzip compressed data, was "terrainman-0.0.9.tar", max compression
```

## Comparing `terrainman-0.0.14.tar` & `terrainman-0.0.9.tar`

### file list

```diff
@@ -1,6 +1,6 @@
--rw-r--r--   0        0        0     1070 2023-05-10 17:44:29.464943 terrainman-0.0.14/LICENSE
--rw-r--r--   0        0        0        4 2023-05-10 17:38:08.409616 terrainman-0.0.14/README.md
--rw-r--r--   0        0        0      946 2023-05-10 18:39:56.992567 terrainman-0.0.14/pyproject.toml
--rw-r--r--   0        0        0      638 2023-05-10 18:39:52.220297 terrainman-0.0.14/src/terrainman/__init__.py
--rw-r--r--   0        0        0     9600 2023-05-10 18:34:18.488944 terrainman-0.0.14/src/terrainman/tile_io.py
--rw-r--r--   0        0        0     1039 1970-01-01 00:00:00.000000 terrainman-0.0.14/PKG-INFO
...
### Comparing `terrainman-0.0.14/LICENSE` & `terrainman-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `terrainman-0.0.14/pyproject.toml` & `terrainman-0.0.9/pyproject.toml`
...
### Comparing `terrainman-0.0.14/src/terrainman/tile_io.py` & `terrainman-0.0.9/src/tile_io.py`
...
### Comparing `terrainman-0.0.14/PKG-INFO` & `terrainman-0.0.9/PKG-INFO`
