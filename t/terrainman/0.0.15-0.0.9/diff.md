# Comparing `tmp/terrainman-0.0.15.tar.gz` & `tmp/terrainman-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "terrainman-0.0.15.tar", max compression
+gzip compressed data, was "terrainman-0.0.9.tar", max compression
```

## Comparing `terrainman-0.0.15.tar` & `terrainman-0.0.9.tar`

### file list

```diff
@@ -1,6 +1,6 @@
--rw-r--r--   0        0        0     1070 2023-05-10 17:44:29.464943 terrainman-0.0.15/LICENSE
--rw-r--r--   0        0        0        4 2023-05-10 17:38:08.409616 terrainman-0.0.15/README.md
--rw-r--r--   0        0        0      946 2023-05-10 18:51:45.972403 terrainman-0.0.15/pyproject.toml
--rw-r--r--   0        0        0     1009 2023-05-10 18:51:37.887480 terrainman-0.0.15/src/terrainman/__init__.py
--rw-r--r--   0        0        0     9600 2023-05-10 18:34:18.488944 terrainman-0.0.15/src/terrainman/tile_io.py
--rw-r--r--   0        0        0     1039 1970-01-01 00:00:00.000000 terrainman-0.0.15/PKG-INFO
...
### Comparing `terrainman-0.0.15/LICENSE` & `terrainman-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `terrainman-0.0.15/pyproject.toml` & `terrainman-0.0.9/pyproject.toml`
...
### Comparing `terrainman-0.0.15/src/terrainman/tile_io.py` & `terrainman-0.0.9/src/tile_io.py`
...
### Comparing `terrainman-0.0.15/PKG-INFO` & `terrainman-0.0.9/PKG-INFO`
