# Comparing `tmp/codeoffer-0.4.0.tar.gz` & `tmp/codeoffer-0.5.0.tar.gz`
...
## Comparing `codeoffer-0.4.0.tar` & `codeoffer-0.5.0.tar`
...
### Comparing `codeoffer-0.4.0/README.md` & `codeoffer-0.5.0/README.md`

 * *Files identical despite different names*

### Comparing `codeoffer-0.4.0/setup.py` & `codeoffer-0.5.0/setup.py`
