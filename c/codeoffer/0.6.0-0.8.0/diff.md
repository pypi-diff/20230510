# Comparing `tmp/codeoffer-0.6.0.tar.gz` & `tmp/codeoffer-0.8.0.tar.gz`
...
## Comparing `codeoffer-0.6.0.tar` & `codeoffer-0.8.0.tar`
...
### Comparing `codeoffer-0.6.0/README.md` & `codeoffer-0.8.0/README.md`
