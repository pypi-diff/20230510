# Comparing `tmp/volttron_lib_sql_historian-0.1.1a8.tar.gz` & `tmp/volttron_lib_sql_historian-0.2.0rc0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "volttron_lib_sql_historian-0.1.1a8.tar", max compression
+gzip compressed data, was "volttron_lib_sql_historian-0.2.0rc0.tar", max compression
```

## Comparing `volttron_lib_sql_historian-0.1.1a8.tar` & `volttron_lib_sql_historian-0.2.0rc0.tar`

### file list

```diff
@@ -1,8 +1,9 @@
--rw-r--r--   0        0        0    11928 2023-05-09 23:06:58.018939 volttron_lib_sql_historian-0.1.1a8/LICENSE
--rw-r--r--   0        0        0     3179 2023-05-09 23:06:58.018939 volttron_lib_sql_historian-0.1.1a8/README.md
--rw-r--r--   0        0        0     1139 2023-05-09 23:08:01.079983 volttron_lib_sql_historian-0.1.1a8/pyproject.toml
--rw-r--r--   0        0        0     1134 2023-05-09 23:06:58.018939 volttron_lib_sql_historian-0.1.1a8/src/historian/sql/__init__.py
--rw-r--r--   0        0        0    20476 2023-05-09 23:06:58.018939 volttron_lib_sql_historian-0.1.1a8/src/historian/sql/basedb.py
--rw-r--r--   0        0        0    15683 2023-05-09 23:06:58.018939 volttron_lib_sql_historian-0.1.1a8/src/historian/sql/historian.py
--rw-r--r--   0        0        0     1672 2023-05-09 23:06:58.018939 volttron_lib_sql_historian-0.1.1a8/src/historian/sql/sqlutils.py
--rw-r--r--   0        0        0     3890 1970-01-01 00:00:00.000000 volttron_lib_sql_historian-0.1.1a8/PKG-INFO
...
### Comparing `volttron_lib_sql_historian-0.1.1a8/LICENSE` & `volttron_lib_sql_historian-0.2.0rc0/LICENSE`

 * *Files identical despite different names*

### Comparing `volttron_lib_sql_historian-0.1.1a8/README.md` & `volttron_lib_sql_historian-0.2.0rc0/setup.py`
...
### Comparing `volttron_lib_sql_historian-0.1.1a8/pyproject.toml` & `volttron_lib_sql_historian-0.2.0rc0/pyproject.toml`
...
### Comparing `volttron_lib_sql_historian-0.1.1a8/src/historian/sql/__init__.py` & `volttron_lib_sql_historian-0.2.0rc0/src/historian/sql/__init__.py`

 * *Files identical despite different names*

### Comparing `volttron_lib_sql_historian-0.1.1a8/src/historian/sql/basedb.py` & `volttron_lib_sql_historian-0.2.0rc0/src/historian/sql/basedb.py`

 * *Files identical despite different names*

### Comparing `volttron_lib_sql_historian-0.1.1a8/src/historian/sql/historian.py` & `volttron_lib_sql_historian-0.2.0rc0/src/historian/sql/historian.py`

 * *Files identical despite different names*

### Comparing `volttron_lib_sql_historian-0.1.1a8/src/historian/sql/sqlutils.py` & `volttron_lib_sql_historian-0.2.0rc0/src/historian/sql/sqlutils.py`

 * *Files identical despite different names*

### Comparing `volttron_lib_sql_historian-0.1.1a8/PKG-INFO` & `volttron_lib_sql_historian-0.2.0rc0/PKG-INFO`
