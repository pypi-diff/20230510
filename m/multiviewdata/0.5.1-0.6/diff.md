# Comparing `tmp/multiviewdata-0.5.1.tar.gz` & `tmp/multiviewdata-0.6.tar.gz`
...
### Comparing `multiviewdata-0.5.1/multiviewdata/torchdatasets/generic.py` & `multiviewdata-0.6/multiviewdata/torchdatasets/generic.py`
