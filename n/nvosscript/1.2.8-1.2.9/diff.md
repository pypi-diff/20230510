# Comparing `tmp/nvosscript-1.2.8.tar.gz` & `tmp/nvosscript-1.2.9.tar.gz`
...
+gzip compressed data, was "nvosscript-1.2.9.tar", last modified: Tue May  9 10:32:47 2023, max compression
```

## Comparing `nvosscript-1.2.8.tar` & `nvosscript-1.2.9.tar`
...
+drwxr-xr-x   0 matador.wang   (503) staff       (20)        0 2023-05-09 10:32:47.438226 nvosscript-1.2.9/
+-rw-r--r--   0 matador.wang   (503) staff       (20)     1073 2023-04-11 06:52:30.000000 nvosscript-1.2.9/LICENSE
+-rw-r--r--   0 matador.wang   (503) staff       (20)      333 2023-05-09 10:32:47.438068 nvosscript-1.2.9/PKG-INFO
+-rw-r--r--   0 matador.wang   (503) staff       (20)       78 2023-04-11 06:52:30.000000 nvosscript-1.2.9/README.md
+drwxr-xr-x   0 matador.wang   (503) staff       (20)        0 2023-05-09 10:32:47.435334 nvosscript-1.2.9/nvos/
+-rw-r--r--   0 matador.wang   (503) staff       (20)        0 2023-04-11 06:52:30.000000 nvosscript-1.2.9/nvos/__init__.py
+-rw-r--r--   0 matador.wang   (503) staff       (20)    13051 2023-05-09 07:53:48.000000 nvosscript-1.2.9/nvos/file.py
+-rw-r--r--   0 matador.wang   (503) staff       (20)     1662 2023-04-11 07:50:33.000000 nvosscript-1.2.9/nvos/login.py
+-rw-r--r--   0 matador.wang   (503) staff       (20)     8953 2023-05-09 10:32:33.000000 nvosscript-1.2.9/nvos/remote.py
+-rw-r--r--   0 matador.wang   (503) staff       (20)     4796 2023-05-04 01:42:28.000000 nvosscript-1.2.9/nvos/run.py
+-rw-r--r--   0 matador.wang   (503) staff       (20)      985 2023-05-04 01:42:28.000000 nvosscript-1.2.9/nvos/utils.py
+drwxr-xr-x   0 matador.wang   (503) staff       (20)        0 2023-05-09 10:32:47.436310 nvosscript-1.2.9/nvosscript.egg-info/
+-rw-r--r--   0 matador.wang   (503) staff       (20)      333 2023-05-09 10:32:47.000000 nvosscript-1.2.9/nvosscript.egg-info/PKG-INFO
+-rw-r--r--   0 matador.wang   (503) staff       (20)      500 2023-05-09 10:32:47.000000 nvosscript-1.2.9/nvosscript.egg-info/SOURCES.txt
+-rw-r--r--   0 matador.wang   (503) staff       (20)        1 2023-05-09 10:32:47.000000 nvosscript-1.2.9/nvosscript.egg-info/dependency_links.txt
+-rw-r--r--   0 matador.wang   (503) staff       (20)       41 2023-05-09 10:32:47.000000 nvosscript-1.2.9/nvosscript.egg-info/entry_points.txt
+-rw-r--r--   0 matador.wang   (503) staff       (20)       47 2023-05-09 10:32:47.000000 nvosscript-1.2.9/nvosscript.egg-info/requires.txt
+-rw-r--r--   0 matador.wang   (503) staff       (20)       27 2023-05-09 10:32:47.000000 nvosscript-1.2.9/nvosscript.egg-info/top_level.txt
+-rw-r--r--   0 matador.wang   (503) staff       (20)       38 2023-05-09 10:32:47.438298 nvosscript-1.2.9/setup.cfg
+-rw-r--r--   0 matador.wang   (503) staff       (20)      805 2023-05-09 07:56:35.000000 nvosscript-1.2.9/setup.py
+drwxr-xr-x   0 matador.wang   (503) staff       (20)        0 2023-05-09 10:32:47.436911 nvosscript-1.2.9/skyeye/
+-rw-r--r--   0 matador.wang   (503) staff       (20)        0 2023-05-04 01:42:28.000000 nvosscript-1.2.9/skyeye/__init__.py
+-rw-r--r--   0 matador.wang   (503) staff       (20)      712 2023-05-04 01:42:28.000000 nvosscript-1.2.9/skyeye/datahandler.py
+-rw-r--r--   0 matador.wang   (503) staff       (20)     1797 2023-05-04 01:42:28.000000 nvosscript-1.2.9/skyeye/remote.py
+-rw-r--r--   0 matador.wang   (503) staff       (20)      240 2023-05-04 01:42:28.000000 nvosscript-1.2.9/skyeye/skyeyecommand.py
+drwxr-xr-x   0 matador.wang   (503) staff       (20)        0 2023-05-09 10:32:47.437333 nvosscript-1.2.9/start/
+-rw-r--r--   0 matador.wang   (503) staff       (20)        0 2023-04-11 07:50:33.000000 nvosscript-1.2.9/start/__init__.py
+-rw-r--r--   0 matador.wang   (503) staff       (20)      185 2023-05-04 01:42:28.000000 nvosscript-1.2.9/start/commonUtil.py
+-rw-r--r--   0 matador.wang   (503) staff       (20)     4529 2023-05-09 07:56:35.000000 nvosscript-1.2.9/start/main.py
+drwxr-xr-x   0 matador.wang   (503) staff       (20)        0 2023-05-09 10:32:47.433107 nvosscript-1.2.9/venv/
+drwxr-xr-x   0 matador.wang   (503) staff       (20)        0 2023-05-09 10:32:47.437584 nvosscript-1.2.9/venv/bin/
+-rw-r--r--   0 matador.wang   (503) staff       (20)     1175 2023-05-09 08:53:30.000000 nvosscript-1.2.9/venv/bin/activate_this.py
+drwxr-xr-x   0 matador.wang   (503) staff       (20)        0 2023-05-09 10:32:47.437812 nvosscript-1.2.9/win/
+-rw-r--r--   0 matador.wang   (503) staff       (20)     1273 2023-05-04 01:42:28.000000 nvosscript-1.2.9/win/win_auto_script.py
```

### Comparing `nvosscript-1.2.8/LICENSE` & `nvosscript-1.2.9/LICENSE`

 * *Files identical despite different names*

### Comparing `nvosscript-1.2.8/nvos/file.py` & `nvosscript-1.2.9/nvos/file.py`
...
### Comparing `nvosscript-1.2.8/nvos/login.py` & `nvosscript-1.2.9/nvos/login.py`

 * *Files identical despite different names*

### Comparing `nvosscript-1.2.8/nvos/remote.py` & `nvosscript-1.2.9/nvos/remote.py`
...
### Comparing `nvosscript-1.2.8/nvos/run.py` & `nvosscript-1.2.9/nvos/run.py`

 * *Files identical despite different names*

### Comparing `nvosscript-1.2.8/nvos/utils.py` & `nvosscript-1.2.9/nvos/utils.py`

 * *Files identical despite different names*

### Comparing `nvosscript-1.2.8/setup.py` & `nvosscript-1.2.9/setup.py`
...
### Comparing `nvosscript-1.2.8/skyeye/datahandler.py` & `nvosscript-1.2.9/skyeye/datahandler.py`

 * *Files identical despite different names*

### Comparing `nvosscript-1.2.8/skyeye/remote.py` & `nvosscript-1.2.9/skyeye/remote.py`

 * *Files identical despite different names*

### Comparing `nvosscript-1.2.8/start/main.py` & `nvosscript-1.2.9/start/main.py`
...
### Comparing `nvosscript-1.2.8/win/win_auto_script.py` & `nvosscript-1.2.9/win/win_auto_script.py`
