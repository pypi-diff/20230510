# Comparing `tmp/uhfReaderApi-0.0.8.tar.gz` & `tmp/uhfReaderApi-0.0.8.1.tar.gz`
...
### Comparing `uhfReaderApi-0.0.8/uhf/reader/protocol/test_vswr_check.py` & `uhfReaderApi-0.0.8.1/uhf/reader/protocol/test_vswr_check.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/protocol/test_workMode_get.py` & `uhfReaderApi-0.0.8.1/uhf/reader/protocol/test_workMode_get.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/protocol/test_workMode_set.py` & `uhfReaderApi-0.0.8.1/uhf/reader/protocol/test_workMode_set.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/protocol/upgrade_app.py` & `uhfReaderApi-0.0.8.1/uhf/reader/protocol/upgrade_app.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/protocol/upgrade_baseband.py` & `uhfReaderApi-0.0.8.1/uhf/reader/protocol/upgrade_baseband.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/utils/HexUtils.py` & `uhfReaderApi-0.0.8.1/uhf/reader/utils/HexUtils.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/utils/ThreadPool.py` & `uhfReaderApi-0.0.8.1/uhf/reader/utils/ThreadPool.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/utils/__init__.py` & `uhfReaderApi-0.0.8.1/uhf/reader/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/utils/byteBuffer.py` & `uhfReaderApi-0.0.8.1/uhf/reader/utils/byteBuffer.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/utils/byteStruct.py` & `uhfReaderApi-0.0.8.1/uhf/reader/utils/byteStruct.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/utils/dateUtils.py` & `uhfReaderApi-0.0.8.1/uhf/reader/utils/dateUtils.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/utils/hid_utils.py` & `uhfReaderApi-0.0.8.1/uhf/reader/utils/hid_utils.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/utils/pcUtils.py` & `uhfReaderApi-0.0.8.1/uhf/reader/utils/pcUtils.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/utils/ring_buffer.py` & `uhfReaderApi-0.0.8.1/uhf/reader/utils/ring_buffer.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhf/reader/utils/usb_utils.py` & `uhfReaderApi-0.0.8.1/uhf/reader/utils/usb_utils.py`

 * *Files identical despite different names*

### Comparing `uhfReaderApi-0.0.8/uhfReaderApi.egg-info/SOURCES.txt` & `uhfReaderApi-0.0.8.1/uhfReaderApi.egg-info/SOURCES.txt`
