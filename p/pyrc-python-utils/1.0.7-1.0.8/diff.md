# Comparing `tmp/pyrc-python-utils-1.0.7.tar.gz` & `tmp/pyrc-python-utils-1.0.8.tar.gz`
...
## Comparing `pyrc-python-utils-1.0.7.tar` & `pyrc-python-utils-1.0.8.tar`
...
### Comparing `pyrc-python-utils-1.0.7/LICENSE` & `pyrc-python-utils-1.0.8/LICENSE`

 * *Files identical despite different names*

### Comparing `pyrc-python-utils-1.0.7/src/pyrc_util_exchange.py` & `pyrc-python-utils-1.0.8/src/pyrc_util_exchange.py`

 * *Files identical despite different names*

### Comparing `pyrc-python-utils-1.0.7/src/pyrc_util_sftp.py` & `pyrc-python-utils-1.0.8/src/pyrc_util_sftp.py`
...
### Comparing `pyrc-python-utils-1.0.7/src/pyrc_util_sharepoint.py` & `pyrc-python-utils-1.0.8/src/pyrc_util_sharepoint.py`
