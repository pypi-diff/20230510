# Comparing `tmp/py-module-parser-0.2.0.tar.gz` & `tmp/py-module-parser-0.3.0b0.tar.gz`
...
## Comparing `py-module-parser-0.2.0.tar` & `py-module-parser-0.3.0b0.tar`
...
### Comparing `py-module-parser-0.2.0/LICENSE` & `py-module-parser-0.3.0b0/LICENSE`

 * *Files identical despite different names*

### Comparing `py-module-parser-0.2.0/py_module_parser/parser.py` & `py-module-parser-0.3.0b0/py_module_parser/parser.py`
...
### Comparing `py-module-parser-0.2.0/pyproject.toml` & `py-module-parser-0.3.0b0/pyproject.toml`
...
### Comparing `py-module-parser-0.2.0/setup.py` & `py-module-parser-0.3.0b0/README.md`
