# Comparing `tmp/PatryksAutoAI-0.0.6.tar.gz` & `tmp/PatryksAutoAI-0.0.7.tar.gz`
...
## Comparing `PatryksAutoAI-0.0.6.tar` & `PatryksAutoAI-0.0.7.tar`
...
### Comparing `PatryksAutoAI-0.0.6/Machine_Learning_Classes/helper_function.py` & `PatryksAutoAI-0.0.7/Machine_Learning_Classes/helper_function.py`

 * *Files identical despite different names*

### Comparing `PatryksAutoAI-0.0.6/setup.py` & `PatryksAutoAI-0.0.7/setup.py`
